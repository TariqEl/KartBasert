...
function cl(t, e, n, i, r) {
  ...
  else if (((a = W0(t)), typeof a == "function"))
...
H.StrictMode = M0;
H.Suspense = N0;
H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Y0;
H.cloneElement = function (t, e, n) {
  ...
  if (e != null) {
    if (
      (e.ref !== void 0 && ((s = e.ref), (o = nh.current)),
...
H.forwardRef = function (t) {
  return { $$typeof: D0, render: t };
};
H.isValidElement = ih;
H.lazy = function (t) {
  return { $$typeof: G0, _payload: { _status: -1, _result: t }, _init: U0 };
};
H.memo = function (t, e) {
  return { $$typeof: z0, type: t, compare: e === void 0 ? null : e };
};
...
function gp(t, e) {
  (e = e.checked), e != null && oh(t, "checked", e, !1);
}
function Ku(t, e) {
  gp(t, e);
  var n = oi(e.value),
  ...
  e.hasOwnProperty("value")
    ? Zu(t, e.type, n)
    : e.hasOwnProperty("defaultValue") && Zu(t, e.type, oi(e.defaultValue)),
    e.checked == null &&
...
function $d(t) {
  if ((t = po(t))) {
    if (typeof ec != "function") throw Error(L(280));
    var e = t.stateNode;
    e && ((e = ga(e)), ec(t.stateNode, t.type, e));
  }
}
function Ep(t) {
...
function wp() {
  if (Tr) {
    var t = Tr,
      e = Ir;
    if (((Ir = Tr = null), $d(t), e)) for (t = 0; t < e.length; t++) $d(e[t]);
  }
}
function xp(t, e) {
  return t(e);
...
function ny(t, e, n, i, r, s, o, l, a) {
  (Rs = !1), (Rl = null), ey.apply(ty, arguments);
}
function iy(t, e, n, i, r, s, o, l, a) {
  if ((ny.apply(this, arguments), Rs)) {
    if (Rs) {
      var u = Rl;
      (Rs = !1), (Rl = null);
...
function Tp(t) {
  return (t = ry(t)), t !== null ? Ip(t) : null;
}
function Ip(t) {
...
var Lp = yt.unstable_scheduleCallback,
  Qd = yt.unstable_cancelCallback,
  sy = yt.unstable_shouldYield,
  oy = yt.unstable_requestPaint,
  we = yt.unstable_now,
  ly = yt.unstable_getCurrentPriorityLevel,
  hh = yt.unstable_ImmediatePriority,
  kp = yt.unstable_UserBlockingPriority,
  Il = yt.unstable_NormalPriority,
  ay = yt.unstable_LowPriority,
  Pp = yt.unstable_IdlePriority,
  ca = null,
  qt = null;
function uy(t) {
...
var jt = Math.clz32 ? Math.clz32 : dy,
  cy = Math.log,
  hy = Math.LN2;
function dy(t) {
  return (t >>>= 0), t === 0 ? 32 : (31 - ((cy(t) / hy) | 0)) | 0;
}
var Wo = 64,
  jo = 4194304;
function vs(t) {
...
function dl(t) {
  ...
  for (var e = t.targetContainers; 0 < e.length; ) {
    var n = sc(t.domEventName, t.eventSystemFlags, e[0], t.nativeEvent);
    if (n === null) {
      n = t.nativeEvent;
      var i = new n.constructor(n.type, n);
      (Ju = i), n.target.dispatchEvent(i), (Ju = null);
    } else return (e = po(n)), e !== null && fh(e), (t.blockedOn = n), !1;
    e.shift();
  }
  return !0;
}
...
function as(t, e) {
  t.blockedOn === e &&
    ...
    rc ||
      ((rc = !0),
      yt.unstable_scheduleCallback(yt.unstable_NormalPriority, yy)));
}
function js(t) {
  function e(r) {
    return as(r, t);
  ...
  for (
    ...
    (i = Bn[n]), i.blockedOn === t && (i.blockedOn = null);
  for (; 0 < Bn.length && ((n = Bn[0]), n.blockedOn === null); )
    zp(n), n.blockedOn === null && Bn.shift();
}
var Lr = Ln.ReactCurrentBatchConfig,
  kl = !0;
function vy(t, e, n, i) {
  var r = re,
    s = Lr.transition;
...
function gh(t, e, n, i) {
  if (kl) {
    var r = sc(t, e, n, i);
    if (r === null) fu(t, e, i, Pl, n), Jd(t, i);
    else if (_y(r, t, e, n, i)) i.stopPropagation();
    else if ((Jd(t, i), e & 4 && -1 < my.indexOf(t))) {
      for (; r !== null; ) {
        var s = po(r);
        if (
          (s !== null && Op(s),
...
var Pl = null;
function sc(t, e, n, i) {
  if (((Pl = null), (t = ch(i)), (t = Ti(t)), t !== null))
...
var Zr = {
  ...
  nf = Et(ha),
  xy = pe({}, ha, { dataTransfer: 0 }),
  Cy = Et(xy),
  Sy = pe({}, go, { relatedTarget: 0 }),
  ou = Et(Sy),
  Ry = pe({}, Zr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Ty = Et(Ry),
  Iy = pe({}, Zr, {
...
var Fy = pe({}, go, {
  ...
  Gy = Et(zy),
  Wy = pe({}, Zr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  jy = Et(Wy),
  Xy = pe({}, ha, {
    deltaX: function (t) {
  ...
  Uy = Et(Xy),
  Yy = [9, 13, 27, 32],
  yh = wn && "CompositionEvent" in window,
  Ts = null;
wn && "documentMode" in document && (Ts = document.documentMode);
var By = wn && "TextEvent" in window && !Ts,
  jp = wn && (!yh || (Ts && 8 < Ts && 11 >= Ts)),
  of = " ",
  lf = !1;
function Xp(t, e) {
  switch (t) {
...
function Vy(t, e) {
  switch (t) {
    case "compositionend":
      return Up(e);
    case "keypress":
      return e.which !== 32 ? null : ((lf = !0), of);
    case "textInput":
      return (t = e.data), t === of && lf ? null : t;
    default:
      return null;
  }
}
function by(t, e) {
  if (dr)
    return t === "compositionend" || (!yh && Xp(t, e))
      ? ((t = Wp()), (fl = ph = bn = null), (dr = !1), t)
      : null;
  switch (t) {
    case "paste":
      return null;
...
function Yp(t, e, n, i) {
  Ep(i),
    (e = Ml(e, "onChange")),
    0 < e.length &&
      ((n = new mh("onChange", "change", null, n, i)),
...
function Vp(t) {
  if (t.propertyName === "value" && da(Xs)) {
    var e = [];
    Yp(e, Xs, t, ch(t)), Sp(Zy, e);
  }
}
function $y(t, e, n) {
  t === "focusin"
    ? (cf(), (Is = e), (Xs = n), Is.attachEvent("onpropertychange", Vp))
    : t === "focusout" && cf();
}
function qy(t) {
...
var Yt = typeof Object.is == "function" ? Object.is : e1;
function Us(t, e) {
  if (Yt(t, e)) return !0;
  ...
  for (i = 0; i < n.length; i++) {
    var r = n[i];
    if (!Xu.call(e, r) || !Yt(t[r], e[r])) return !1;
  }
  return !0;
}
function hf(t) {
...
var n1 = wn && "documentMode" in document && 11 >= document.documentMode,
  fr = null,
  oc = null,
  Ls = null,
  lc = !1;
function ff(t, e, n) {
  ...
  lc ||
    ...
    (Ls && Us(Ls, i)) ||
      ...
      (i = Ml(oc, "onSelect")),
      0 < i.length &&
        ((e = new mh("onSelect", "select", null, e, n)),
...
for (var cu = 0; cu < gf.length; cu++) {
  var hu = gf[cu],
    i1 = hu.toLowerCase(),
    r1 = hu[0].toUpperCase() + hu.slice(1);
  fi(i1, "on" + r1);
}
...
var Es =
  ...
  s1 = new Set("cancel close invalid load scroll toggle".split(" ").concat(Es));
function pf(t, e, n) {
  var i = t.type || "unknown-event";
  (t.currentTarget = n), iy(i, e, void 0, t), (t.currentTarget = null);
}
function em(t, e) {
  e = (e & 4) !== 0;
  ...
  if (Tl) throw ((t = nc), (Tl = !1), (nc = null), t);
}
function ae(t, e) {
  var n = e[dc];
  ...
  if (!t[Bo]) {
    (t[Bo] = !0),
      ap.forEach(function (n) {
        n !== "selectionchange" && (s1.has(n) || du(n, !1, t), du(n, !0, t));
      });
      ...
      S &&
        (jp &&
          ...
          (dr || S !== "onCompositionStart"
            ...
            : ((bn = c),
              (ph = "value" in bn ? bn.value : bn.textContent),
              (dr = !0))),
        (x = Ml(u, S)),
        0 < x.length &&
          ((S = new rf(S, t, null, n, c)),
...
function Vo(t, e, n) {
  if (((e = _f(e)), _f(t) !== e && n)) throw Error(L(425));
}
function Al() {}
var ac = null,
  uc = null;
...
var hc = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  u1 =
    typeof queueMicrotask == "function"
      ...
      : typeof yf < "u"
        ? function (t) {
            return yf.resolve(null).then(t).catch(c1);
          }
        : hc;
function c1(t) {
  setTimeout(function () {
...
var Hr = Math.random().toString(36).slice(2),
  bt = "__reactFiber$" + Hr,
  Vs = "__reactProps$" + Hr,
  xn = "__reactContainer$" + Hr,
  dc = "__reactEvents$" + Hr,
  h1 = "__reactListeners$" + Hr,
  d1 = "__reactHandles$" + Hr;
function Ti(t) {
  var e = t[bt];
  if (e) return e;
...
function ue(t) {
  0 > mr || ((t.current = fc[mr]), (fc[mr] = null), mr--);
}
function le(t, e) {
  mr++, (fc[mr] = t.current), (t.current = e);
}
var li = {},
  Ye = gi(li),
  lt = gi(!1),
...
function nm(t, e, n) {
  ...
  if (((e = e.childContextTypes), typeof i.getChildContext != "function"))
    return n;
  i = i.getChildContext();
  for (var r in i) if (!(r in e)) throw Error(L(108, $0(t) || "Unknown", r));
  return pe({}, n, i);
}
function Fl(t) {
  return (
...
function pi() {
  if (!pu && gn !== null) {
    ...
    try {
      ...
      throw (gn !== null && (gn = gn.slice(t + 1)), Lp(hh, pi), r);
    } finally {
      (re = e), (pu = !1);
    }
  }
...
function rm(t, e, n) {
  (St[Rt++] = mn), (St[Rt++] = _n), (St[Rt++] = zi), (zi = t);
  var i = mn;
  t = _n;
  var r = 32 - jt(i) - 1;
  (i &= ~(1 << r)), (n += 1);
      ...
      return (
        (e =
          e.nodeType !== 1 || n.toLowerCase() !== e.nodeName.toLowerCase()
            ...
            : e),
        e !== null
          ? ((t.stateNode = e), (mt = t), (gt = ei(e.firstChild)), !0)
          : !1
      );
    case 6:
      return (
        (e = t.pendingProps === "" || e.nodeType !== 3 ? null : e),
        e !== null ? ((t.stateNode = e), (mt = t), (gt = null), !0) : !1
      );
    case 13:
      return (
        (e = e.nodeType !== 8 ? null : e),
        e !== null
          ? ((n = zi !== null ? { id: mn, overflow: _n } : null),
            (t.memoizedState = {
              dehydrated: e,
              treeContext: n,
...
function pc(t) {
  if (de) {
    ...
    if (e) {
      var n = e;
      if (!xf(t, e)) {
        if (gc(t)) throw Error(L(418));
        e = ei(n.nextSibling);
        var i = mt;
        e && xf(t, e)
          ? sm(i, n)
          : ((t.flags = (t.flags & -4097) | 2), (de = !1), (mt = t));
      }
    } else {
      if (gc(t)) throw Error(L(418));
      (t.flags = (t.flags & -4097) | 2), (de = !1), (mt = t);
...
function bo(t) {
  if (t !== mt) return !1;
  if (!de) return Cf(t), (de = !0), !1;
  var e;
  if (
    ((e = t.tag !== 3) &&
      !(e = t.tag !== 5) &&
      ((e = t.type),
      (e = e !== "head" && e !== "body" && !cc(t.type, t.memoizedProps))),
    e && (e = gt))
  ) {
    if (gc(t)) throw (om(), Error(L(418)));
  ...
  } else gt = mt ? ei(t.stateNode.nextSibling) : null;
  return !0;
}
function om() {
  for (var t = gt; t; ) t = ei(t.nextSibling);
}
function Nr() {
  (gt = mt = null), (de = !1);
}
...
var g1 = Ln.ReactCurrentBatchConfig;
function Nt(t, e) {
  if (t && t.defaultProps) {
...
function lm(t, e, n, i) {
  var r = e.interleaved;
  return (
    r === null ? ((n.next = n), Th(e)) : ((n.next = r.next), (r.next = n)),
    (e.interleaved = n),
    Cn(t, i)
  );
}
...
function ti(t, e, n) {
  ...
  return (
    (r = i.interleaved),
    r === null ? ((e.next = e), Th(i)) : ((e.next = r.next), (r.next = e)),
    (i.interleaved = e),
    Cn(t, n)
  );
}
function pl(t, e, n) {
  if (
    ...
    var i = e.lanes;
    (i &= t.pendingLanes), (n |= i), (e.lanes = n), dh(t, n);
  }
}
function Sf(t, e) {
  var n = t.updateQueue,
...
function yc(t, e, n, i) {
  var r = t.stateNode;
  (r.props = n), (r.state = t.memoizedState), (r.refs = um), Ih(t);
  var s = e.contextType;
  typeof s == "object" && s !== null
    ? (r.context = Lt(s))
    : ((s = at(e) ? Ni : Ye.current), (r.context = Dr(t, s))),
    (r.state = t.memoizedState),
    (s = e.getDerivedStateFromProps),
    typeof s == "function" && (_c(t, e, s, n), (r.state = t.memoizedState)),
...
function Lh(t, e) {
  switch ((le(Ks, e), le(bs, t), le(Qt, mo), (t = e.nodeType), t)) {
    case 9:
    case 11:
      e = (e = e.documentElement) ? e.namespaceURI : $u(null, "");
      break;
    default:
...
var ml = Ln.ReactCurrentDispatcher,
  _u = Ln.ReactCurrentBatchConfig,
  Gi = 0,
  ge = null,
  Re = null,
  Le = null,
...
function Ah(t, e, n, i, r, s) {
  if (
    ...
    (e.updateQueue = null),
    (e.lanes = 0),
    (ml.current = t === null || t.memoizedState === null ? v1 : E1),
    (t = n(i, r)),
    ks)
  ) {
    s = 0;
...
function pm(t, e) {
  ...
  if (
    (s && ((i.memoizedState = r), (ot = !0)),
    (i = i.queue),
    Fh(ym.bind(null, n, i, t), [t]),
...
function kf(t) {
  ...
  return (
    ...
    (e.queue = t),
    (t = t.dispatch = y1.bind(null, ge, t)),
    [e.memoizedState, t]
  );
}
function $s(t, e, n, i) {
...
function _a(t, e, n, i) {
  ...
  if (Re !== null) {
    ...
    if (((s = o.destroy), i !== null && Mh(i, o.deps))) {
...
var Ul = {
  ...
  v1 = {
    ...
    useTransition: function () {
      var t = kf(!1),
        e = t[0];
      return (t = m1.bind(null, t[1])), (Vt().memoizedState = t), [e, t];
    },
...
function Mf(t, e, n) {
  ...
  r.has(n) || (r.add(n), (t = N1.bind(null, t, e, n)), e.then(t, t));
}
function Af(t) {
  do {
    var e;
  ...
  return (
    ...
    t !== null && !ot
      ? ((e.updateQueue = t.updateQueue),
        ...
        (t.lanes &= ~r),
        Sn(t, e, r))
      : (de && n && Eh(e), (e.flags |= 1), Ve(t, e, i, r), e.child)
  );
}
...
function Dm(t, e, n, i, r) {
  if (t !== null) {
    ...
    if (Us(s, i) && t.ref === e.ref)
      if (((ot = !1), (e.pendingProps = i = s), (t.lanes & r) !== 0))
        t.flags & 131072 && (ot = !0);
      else return (e.lanes = t.lanes), Sn(t, e, r);
  }
  return Ec(t, e, n, i, r);
}
function Nm(t, e, n) {
  ...
  return (
    ...
    t !== null && !ot
      ? ((e.updateQueue = t.updateQueue),
        ...
        (t.lanes &= ~r),
        Sn(t, e, r))
      : (de && i && Eh(e), (e.flags |= 1), Ve(t, e, n, r), e.child)
  );
}
function Nf(t, e, n, i, r) {
  ...
  if ((kr(e, r), e.stateNode === null))
    yl(t, e), cm(e, n, i), yc(e, n, i, r), (i = !0);
  else if (t === null) {
    var o = e.stateNode,
      l = e.memoizedProps;
    o.props = l;
    ...
    (o.state = d),
      Wl(e, i, o, r),
      (a = e.memoizedState),
      l !== i || d !== a || lt.current || Xn
        ? (typeof c == "function" && (_c(e, n, c, i), (a = e.memoizedState)),
          (l = Xn || Tf(e, n, l, i, d, a, u))
            ? (h ||
    ...
    l !== h || d !== m || lt.current || Xn
      ? (typeof f == "function" && (_c(e, n, f, i), (m = e.memoizedState)),
        (u = Xn || Tf(e, n, u, i, d, m, a) || !1)
          ? (c ||
  ...
  return wc(t, e, n, i, s, r);
}
function wc(t, e, n, i, r, s) {
  zm(t, e);
  var o = (e.flags & 128) !== 0;
  if (!i && !o) return r && wf(e, n, !1), Sn(t, e, s);
  (i = e.stateNode), (C1.current = e);
  var l =
...
function Gm(t) {
  ...
  e.pendingContext
    ...
    Lh(t, e.containerInfo);
}
function zf(t, e, n, i, r) {
  return Nr(), xh(r), (e.flags |= 256), Ve(t, e, n, i), e.child;
}
...
function Zo(t, e, n, i) {
  return (
    i !== null && xh(i),
    zr(e, t.child, null, n),
    (t = Nh(e, e.pendingProps.children)),
    (t.flags |= 2),
    (e.memoizedState = null),
    t
  );
}
function S1(t, e, n, i, r, s, o) {
  if (n)
    return e.flags & 256
  ...
  if (((l = (o & t.childLanes) !== 0), ot || l)) {
    if (((i = Pe), i !== null)) {
      ...
      (r = r & (i.suspendedLanes | o) ? 0 : r),
        r !== 0 &&
          r !== s.retryLane &&
          ((s.retryLane = r), Cn(t, r), Xt(i, t, r, -1));
    }
    return Uh(), (i = Eu(Error(L(421)))), Zo(t, e, o, i);
  }
  return r.data === "$?"
    ? ((e.flags |= 128),
      (e.child = t.child),
...
function Gf(t, e, n) {
  t.lanes |= e;
  var i = t.alternate;
  i !== null && (i.lanes |= e), mc(t.return, e, n);
}
  ...
  switch ((wh(e), e.tag)) {
        ...
        (t === null || t.child === null) &&
          (bo(e)
            ...
            : t === null ||
              ...
              ((e.flags |= 1024), Gt !== null && (Ac(Gt), (Gt = null)))),
        Sc(t, e),
        ze(e),
        null
      );
    ...
    case 13:
      if (
        ...
        if (de && gt !== null && e.mode & 1 && !(e.flags & 128))
          ...
          ze(e), (s = !1);
        } else Gt !== null && (Ac(Gt), (Gt = null)), (s = !0);
      ...
      return e.flags & 128
        ...
        : ((i = i !== null),
          i !== (t !== null && t.memoizedState !== null) &&
            ...
            ((e.child.flags |= 8192),
            e.mode & 1 &&
              (t === null || fe.current & 1 ? Te === 0 && (Te = 3) : Uh())),
          e.updateQueue !== null && (e.flags |= 4),
          ze(e),
          null);
    case 4:
      return (
        Gr(), Sc(t, e), t === null && Ys(e.stateNode.containerInfo), ze(e), null
      );
    case 10:
      return Rh(e.type._context), ze(e), null;
    case 17:
      return at(e.type) && Ol(), ze(e), null;
    case 19:
    ...
    case 23:
      return (
        ...
        i && e.mode & 1
          ? dt & 1073741824 && (ze(e), e.subtreeFlags & 6 && (e.flags |= 8192))
          : ze(e),
        null
      );
    case 24:
...
function k1(t, e) {
  ...
  for (uc = { focusedElem: t, selectionRange: n }, kl = !1, O = e; O !== null; )
...
function Ps(t, e, n) {
  ...
  if (((i = i !== null ? i.lastEffect : null), i !== null)) {
    ...
    do {
      if ((r.tag & t) === t) {
        var s = r.destroy;
        (r.destroy = void 0), s !== void 0 && Rc(e, n, s);
      }
      r = r.next;
    } while (r !== i);
  }
...
function Bm(t) {
  ...
  e !== null && ((t.alternate = null), Bm(e)),
    ...
    t.tag === 5 &&
      ((e = t.stateNode),
      e !== null &&
        (delete e[bt], delete e[Vs], delete e[dc], delete e[h1], delete e[d1])),
    (t.stateNode = null),
    (t.return = null),
    (t.dependencies = null),
...
function bm(t, e, n) {
  ...
  switch (n.tag) {
    ...
    case 22:
      n.mode & 1
        ? ((je = (i = je) || n.memoizedState !== null), On(t, e, n), (je = i))
        : On(t, e, n);
      break;
    default:
      On(t, e, n);
...
function Xf(t) {
  ...
  if (e !== null) {
    t.updateQueue = null;
    var n = t.stateNode;
    n === null && (n = t.stateNode = new L1()),
      e.forEach(function (i) {
        var r = G1.bind(null, t, i);
...
function Zm(t, e, n) {
  for (var i = (t.mode & 1) !== 0; O !== null; ) {
    ...
    if (r.tag === 22 && i) {
      ...
      r.subtreeFlags & 8772 && s !== null ? ((s.return = r), (O = s)) : Uf(t);
  }
}
function Uf(t) {
  for (; O !== null; ) {
...
var M1 = Math.ceil,
  Yl = Ln.ReactCurrentDispatcher,
  zh = Ln.ReactCurrentOwner,
  It = Ln.ReactCurrentBatchConfig,
  q = 0,
  Pe = null,
  Ce = null,
  Oe = 0,
...
function Xt(t, e, n, i) {
  if (50 < As) throw ((As = 0), (Pc = null), Error(L(185)));
  fo(t, n, i),
    (!(q & 2) || t !== Pe) &&
      (t === Pe && (!(q & 2) && (va |= n), Te === 4 && Vn(t, Oe)),
      ut(t, i),
...
function ut(t, e) {
  ...
  if (i === 0)
    n !== null && Qd(n), (t.callbackNode = null), (t.callbackPriority = 0);
  else if (((e = i & -i), t.callbackPriority !== e)) {
    if ((n != null && Qd(n), e === 1))
      t.tag === 0 ? f1(Vf.bind(null, t)) : im(Vf.bind(null, t)),
        u1(function () {
          !(q & 6) && pi();
        }),
        (n = null);
...
function Hm(t, e) {
  ...
  if (e !== 0) {
    if (
      (e === 2 && ((r = ic(t)), r !== 0 && ((i = r), (e = Mc(t, r)))), e === 1)
    )
      throw ((n = qs), Oi(t, 0), Vn(t, i), ut(t, we()), n);
    if (e === 6) Vn(t, i);
    else {
      if (
      ...
      switch (((t.finishedWork = r), (t.finishedLanes = i), e)) {
        ...
        case 3:
          if (
            (Vn(t, i), (i & 130023424) === i && ((e = Wh + 500 - we()), 10 < e))
          ) {
            if (Ll(t, 0) !== 0) break;
            ...
            t.timeoutHandle = hc(Ci.bind(null, t, tt, fn), e);
            break;
          }
          Ci(t, tt, fn);
          break;
        case 4:
          if ((Vn(t, i), (i & 4194240) === i)) break;
          ...
          if (
            ...
            t.timeoutHandle = hc(Ci.bind(null, t, tt, fn), i);
            break;
          }
          Ci(t, tt, fn);
          break;
  ...
  return ut(t, we()), t.callbackNode === n ? Hm.bind(null, t) : null;
}
function Mc(t, e) {
  var n = Ms;
  return (
...
function Vf(t) {
  ...
  Pr();
  var e = Ll(t, 0);
  if (!(e & 1)) return ut(t, we()), null;
  var n = bl(t, e);
  if (t.tag !== 0 && n === 2) {
    var i = ic(t);
    i !== 0 && ((e = i), (n = Mc(t, i)));
  }
  if (n === 1) throw ((n = qs), Oi(t, 0), Vn(t, e), ut(t, we()), n);
...
function Oi(t, e) {
  ...
  if ((n !== -1 && ((t.timeoutHandle = -1), a1(n)), Ce !== null))
...
function Uh() {
  (Te === 0 || Te === 3 || Te === 2) && (Te = 4),
    Pe === null || (!(Wi & 268435455) && !(va & 268435455)) || Vn(Pe, Oe);
}
function bl(t, e) {
  var n = q;
  q |= 2;
  ...
  while (!0);
  if ((Sh(), (q = n), (Yl.current = i), Ce !== null)) throw Error(L(261));
...
function F1() {
  for (; Ce !== null && !sy(); ) Qm(Ce);
}
function Qm(t) {
  var e = t_(t.alternate, t, dt);
...
function Ci(t, e, n) {
  var i = re,
    r = It.transition;
  try {
    (It.transition = null), (re = 1), D1(t, e, n, i);
  } finally {
...
function D1(t, e, n, i) {
  ...
  if (Bl) throw ((Bl = !1), (t = kc), (kc = null), t);
  return (
    Vl & 1 && t.tag !== 0 && Pr(),
    (s = t.pendingLanes),
    s & 1 ? (t === Pc ? As++ : ((As = 0), (Pc = t))) : (As = 0),
    pi(),
    null
  );
}
...
function N1(t, e, n) {
  ...
  i !== null && i.delete(e),
    ...
    Pe === t &&
      (Oe & n) === n &&
      (Te === 4 || (Te === 3 && (Oe & 130023424) === Oe && 500 > we() - Wh)
        ? Oi(t, 0)
        : (Gh |= n)),
    ut(t, e);
}
function e_(t, e) {
  e === 0 &&
    (t.mode & 1
      ...
      : (e = 1));
  var n = be();
  (t = Cn(t, e)), t !== null && (fo(t, e, n), ut(t, n));
}
function z1(t) {
  var e = t.memoizedState,
    n = 0;
...
t_ = function (t, e, n) {
  if (t !== null)
    if (t.memoizedProps !== e.pendingProps || lt.current) ot = !0;
    else {
      if (!(t.lanes & n) && !(e.flags & 128)) return (ot = !1), R1(t, e, n);
      ot = !!(t.flags & 131072);
    }
  else (ot = !1), de && e.flags & 1048576 && rm(e, Nl, e.index);
  switch (((e.lanes = 0), e.tag)) {
    case 2:
      var i = e.type;
      yl(t, e), (t = e.pendingProps);
      var r = Dr(e, Ye.current);
      kr(e, n), (r = Ah(null, e, i, t, r, n));
      var s = Oh();
      return (
        (e.flags |= 1),
        typeof r == "object" &&
        ...
        r.$$typeof === void 0
          ? ((e.tag = 1),
            ...
            yc(e, i, t, n),
            (e = wc(null, e, i, !0, s, n)))
          : ((e.tag = 0), de && s && Eh(e), Ve(null, e, r, n), (e = e.child)),
        e
      );
    case 16:
      i = e.elementType;
      ...
      e: {
        ...
        if (((i = o.element), s.isDehydrated))
          if (
            ...
            (r = Wr(Error(L(423)), e)), (e = zf(t, e, i, n, r));
            break e;
          } else if (i !== r) {
            (r = Wr(Error(L(424)), e)), (e = zf(t, e, i, n, r));
            break e;
          } else
            for (
              gt = ei(e.stateNode.containerInfo.firstChild),
                mt = e,
                de = !0,
                Gt = null,
                n = dm(e, null, i, n),
    ...
    case 5:
      return (
        ...
        (o = r.children),
        cc(i, r) ? (o = null) : s !== null && cc(i, s) && (e.flags |= 32),
        zm(t, e),
        Ve(t, e, o, n),
        e.child
      );
    case 6:
      return t === null && pc(e), null;
    case 13:
      return Wm(t, e, n);
    case 4:
      return (
    ...
    case 10:
      e: {
        if (
          ...
          if (Yt(s.value, o)) {
            if (s.children === r.children && !lt.current) {
              e = Sn(t, e, n);
              break e;
            }
          } else
...
function Tt(t, e, n, i) {
  return new W1(t, e, n, i);
}
function Yh(t) {
  return (t = t.prototype), !(!t || !t.isReactComponent);
}
function j1(t) {
  if (typeof t == "function") return Yh(t) ? 1 : 0;
  if (t != null) {
    if (((t = t.$$typeof), t === ah)) return 11;
    if (t === uh) return 14;
  }
  return 2;
}
...
function wl(t, e, n, i, r, s) {
  var o = 2;
  if (((i = t), typeof t == "function")) Yh(t) && (o = 1);
    ...
    e: switch (t) {
      ...
      case Uu:
        return (
          (t = Tt(12, n, e, r | 2)), (t.elementType = Uu), (t.lanes = s), t
        );
      case Yu:
        return (t = Tt(13, n, e, r)), (t.elementType = Yu), (t.lanes = s), t;
      case Bu:
        return (t = Tt(19, n, e, r)), (t.elementType = Bu), (t.lanes = s), t;
      case hp:
        return Ea(n, r, s, e);
      default:
...
function i_(t) {
  ...
  if (t.tag === 1) {
    var n = t.type;
    if (at(n)) return nm(t, n, e);
  }
  return e;
}
function r_(t, e, n, i, r, s, o, l, a) {
  return (
    (t = Bh(n, i, !0, t, r, s, o, l, a)),
    (t.context = i_(null)),
    (n = t.current),
    (i = be()),
    (r = ii(n)),
...
xa.prototype.render = bh.prototype.render = function (t) {
  var e = this._internalRoot;
  if (e === null) throw Error(L(409));
  wa(t, e, null, null);
};
xa.prototype.unmount = bh.prototype.unmount = function () {
...
function B1(t, e, n, i, r) {
  ...
  var a = Bh(t, 0, !1, null, null, !1, !1, "", Zf);
  return (
  ...
  switch (t.tag) {
    case 3:
      ...
      if (e.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (dh(e, n | 1), ut(e, we()), !(q & 6) && ((jr = we() + 500), pi()));
      }
      break;
    case 13:
      ji(function () {
...
ec = function (t, e, n) {
  switch (e) {
    case "input":
      if ((Ku(t, n), (e = n.name), n.type === "radio" && e != null)) {
...
xp = jh;
Cp = ji;
var V1 = { usingClientEntryPoint: !1, Events: [po, pr, ga, Ep, wp, jh] },
  ds = {
  ...
  b1 = {
    ...
    findFiberByHostInstance: ds.findFiberByHostInstance || Y1,
...
vt.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = V1;
vt.createPortal = function (t, e) {
  var n = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
  if (!Kh(e)) throw Error(L(200));
  return U1(t, e, null, n);
};
vt.createRoot = function (t, e) {
  if (!Kh(t)) throw Error(L(299));
  var n = !1,
    i = "",
    r = s_;
  return (
...
vt.unstable_batchedUpdates = jh;
vt.unstable_renderSubtreeIntoContainer = function (t, e, n, i) {
...
var K1 = rp.exports,
  Hf = K1;
(ju.createRoot = Hf.createRoot), (ju.hydrateRoot = Hf.hydrateRoot);
class kn {
  constructor(e) {
...
class nn extends yo {
  ...
  notify(e, n) {
    let i;
    (i = `change:${e}`),
      this.hasListener(i) && this.dispatchEvent(new $f(i, e, n)),
      (i = Xr.PROPERTYCHANGE),
      this.hasListener(i) && this.dispatchEvent(new $f(i, e, n));
  }
...
class Ht extends nn {
  ...
  insertAt(e, n) {
    ...
    this.unique_ && this.assertUnique_(n),
      ...
      this.updateLength_(),
      this.dispatchEvent(new Qo(nt.ADD, n, e));
  }
  pop() {
  ...
  removeAt(e) {
    ...
    return (
      ...
      this.updateLength_(),
      this.dispatchEvent(new Qo(nt.REMOVE, n, e)),
      n
    );
  }
  setAt(e, n) {
    ...
    (this.array_[e] = n),
      this.dispatchEvent(new Qo(nt.REMOVE, r, e)),
      this.dispatchEvent(new Qo(nt.ADD, n, e));
  }
  updateLength_() {
...
class Ia extends nn {
  ...
  setStyle(e) {
    (this.style_ = e),
      (this.styleFunction_ = e ? J1(e) : void 0),
      this.changed();
  }
  setId(e) {
...
const ui =
    typeof navigator < "u" && typeof navigator.userAgent < "u"
      ...
      : "",
  ev = ui.includes("firefox"),
  tv = ui.includes("safari") && !ui.includes("chrom");
tv &&
  (ui.includes("version/15.4") ||
    /cpu (os|iphone os) 15_4 like mac os x/.test(ui));
const nv = ui.includes("webkit") && !ui.includes("edge"),
...
function sv(t, e, n) {
  return iv(t, e, 0, 0, n, 0, 0);
}
function Rn(t, e, n, i, r, s, o, l) {
  const a = Math.sin(s),
    u = Math.cos(s);
  return (
    (t[0] = i * u),
...
function d_(t) {
  ...
  if ($h) return e;
  const n = Qf || (Qf = document.createElement("div"));
...
function Dc(t, e, n, i, r) {
  const [s, o, l, a, u, c, h, d] = Nc(t, e, n, i);
  return Tn(
    Math.min(s, l, u, h),
    Math.min(o, a, c, d),
    Math.max(s, l, u, h),
...
function Ev(t) {
  return (
    zc[t] ||
    zc[t.replace(/urn:(x-)?ogc:def:crs:EPSG:(.*:)?(\w+)$/, "EPSG:$3")] ||
    null
  );
}
function wv(t, e) {
...
function el(t, e) {
  return Math.floor(td(t, e));
}
function tl(t, e) {
  return Math.ceil(td(t, e));
}
function Rv(t, e) {
...
function Pv(t) {
  wv(t.getCode(), t), Hl(t, t, id);
}
function Mv(t) {
  t.forEach(Pv);
}
function ve(t) {
  return typeof t == "string" ? Ev(t) : t || null;
}
function rg(t, e, n, i) {
  t = ve(t);
  let r;
  ...
  if (s) {
    ...
    if ((o == "degrees" && !i) || i == "degrees") r = e;
      ...
      if (l === x_ && o !== "degrees") r = e * t.getMetersPerUnit();
        ...
        u = l(u, u, 2);
        const c = ig(u.slice(0, 2), u.slice(2, 4)),
          h = ig(u.slice(4, 6), u.slice(6, 8));
        r = (c + h) / 2;
      }
...
function Ri(t, e) {
  ...
  return (t.getCode() === e.getCode() || Aa(t, e) === id) && n;
}
function Aa(t, e) {
  const n = t.getCode(),
    i = e.getCode();
        ...
        i.getUnits() == "tile-pixels"
          ? function (s, o, l) {
              const a = i.getExtent(),
                ...
                c = _t(u) / _t(a);
              return (
                Rn(og, u[0], u[3], c, -c, 0, 0, 0),
                si(s, 0, s.length, l, og, o),
                Yr(i, n)(s, o, l)
              );
            }
          : Yr(i, n);
...
class bi extends T_ {
  ...
  setFlatCoordinates(e, n) {
    (this.stride = lg(e)), (this.layout = e), (this.flatCoordinates = n);
  }
  setCoordinates(e, n) {
    W();
  }
  ...
  scale(e, n, i) {
    ...
    if (r) {
      ...
      zv(r, 0, r.length, s, e, n, i, r), this.changed();
    }
  }
  translate(e, n) {
    const i = this.getFlatCoordinates();
    if (i) {
      const r = this.getStride();
      Gv(i, 0, i.length, r, e, n, i), this.changed();
    }
  }
}
function Ki(t) {
...
function ag(t, e, n, i, r, s, o) {
  ...
  if (u === 0 && c === 0) h = e;
    ...
    if (d > 1) h = n;
      ...
      for (let f = 0; f < i; ++f) o[f] = ft(t[e + f], t[n + f], d);
      o.length = i;
      return;
    } else h = e;
  }
...
function jv(t, e, n, i, r) {
  for (let s = 0, o = n.length; s < o; ++s) {
    const l = n[s];
    (r = ld(t, e, l, i, r)), (e = l[l.length - 1]);
  }
  return r;
}
function ad(t, e, n, i, r, s, o, l, a, u, c) {
  if (e == n) return u;
  let h, d;
  if (r === 0) {
  ...
  let f = e + i;
  for (; f < n; )
    if ((ag(t, f - i, f, i, o, l, c), (d = Di(o, l, c[0], c[1])), d < u)) {
      for (u = d, h = 0; h < i; ++h) a[h] = c[h];
      (a.length = i), (f += i);
    } else f += i * Math.max(((Math.sqrt(d) - Math.sqrt(u)) / r) | 0, 1);
  if (s && (ag(t, n - i, e, i, o, l, c), (d = Di(o, l, c[0], c[1])), d < u)) {
    for (u = d, h = 0; h < i; ++h) a[h] = c[h];
    a.length = i;
  }
  return u;
...
function ud(t, e, n, i, r, s, o, l, a, u, c) {
  ...
  for (let h = 0, d = n.length; h < d; ++h) {
    const f = n[h];
    (u = ad(t, e, f, i, r, s, o, l, a, u, c)), (e = f);
  }
  return u;
}
function Xv(t, e, n, i, r, s, o, l, a, u, c) {
  c = c || [NaN, NaN];
  for (let h = 0, d = n.length; h < d; ++h) {
    const f = n[h];
    (u = ud(t, e, f, i, r, s, o, l, a, u, c)), (e = f[f.length - 1]);
  }
  return u;
}
function Uv(t, e, n, i) {
...
function cd(t, e, n, i, r, s, o, l) {
  for (let a = 0, u = n.length; a < u; ++a) {
    const c = n[a];
    (o = Yv(t, e, c, i, r, s, o)), l.push(o), (e = c);
  }
  return o;
}
function Bv(t, e, n, i, r, s, o, l) {
  for (let a = 0, u = n.length; a < u; ++a) {
    const c = n[a],
      h = [];
    (o = cd(t, e, c, i, r, s, o, h)), l.push(h), (e = c[c.length - 1]);
  }
  return o;
}
...
class Br extends bi {
  ...
  intersectsExtent(e) {
    return Jh(e, this.flatCoordinates[0], this.flatCoordinates[1]);
  }
  setCoordinates(e, n) {
    this.setLayout(n, e, 0),
      this.flatCoordinates || (this.flatCoordinates = []),
      (this.flatCoordinates.length = Uv(
        this.flatCoordinates,
        0,
        e,
        this.stride,
...
function Kv(t, e, n, i, r, s) {
  if (n.length === 0) return !1;
  for (let o = 0, l = n.length; o < l; ++o) {
    const a = n[o];
    if (hd(t, e, a, i, r, s)) return !0;
    e = a[a.length - 1];
  }
  return !1;
}
function dd(t, e, n, i, r, s, o) {
  let l, a, u, c, h, d, f;
  const m = r[s + 1],
    y = [];
  ...
  for (y.sort(ai), c = y[0], l = 1, a = y.length; l < a; ++l) {
    ...
    g > p && ((u = (c + h) / 2), hd(t, e, n, i, u, m) && ((v = u), (p = g))),
      (c = h);
  }
...
function M_(t, e, n, i, r) {
  ...
  for (let o = 0, l = n.length; o < l; ++o) {
    const a = n[o];
    (s = dd(t, e, a, i, r, 2 * o, s)), (e = a[a.length - 1]);
  }
  return s;
}
...
class hi extends bi {
  ...
  closestPointXY(e, n, i, r) {
    return r < Bi(this.getExtent(), e, n)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ((this.maxDelta_ = Math.sqrt(
            ld(this.flatCoordinates, 0, this.ends_, this.stride, 0),
          )),
          (this.maxDeltaRevision_ = this.getRevision())),
        ud(
          this.flatCoordinates,
...
function Yc(t, e, n, i, r, s) {
  ...
  o = [];
  for (let d = 0; d < i - 1; ++d)
    o.push(ft(t[(l - 1) * i + d], t[l * i + d], h));
  return o.push(r), o;
}
function Qv(t, e, n, i, r, s, o) {
  if (o) return Yc(t, e, n[n.length - 1], i, r, s);
  let l;
  ...
  for (let a = 0, u = n.length; a < u; ++a) {
    ...
    if (e != c) {
      ...
      if (r <= t[c - 1]) return Yc(t, e, c, i, r, !1);
      e = c;
    }
  }
  return null;
...
class za {
  ...
  setScale(e) {
    (this.scale_ = e), (this.scaleArray_ = pt(e));
  }
  listenImageChange(e) {
    W();
  }
...
function tE(t) {
  ...
  if (((t = String(t).toLowerCase()), hg[t])) (n = hg[t].slice()), (r = "rgb");
...
const nl = "ol-hidden",
  ...
  mg = ["style", "variant", "weight", "size", "lineHeight", "family"],
  X_ = function (t) {
    const e = t.match(uE);
    if (!e) return null;
    const n = {
...
`),
            ...
            ? (_o(Kc), (or = null), (bc = void 0), dn.set(f, 100))
...
function fE(t, e, n, i, r, s, o, l, a, u, c) {
  t.save(),
    n !== 1 && (t.globalAlpha *= n),
    e && t.transform.apply(t, e),
    i.contextInstructions
      ? (t.translate(a, u), t.scale(c[0], c[1]), gE(i, t))
      : c[0] < 0 || c[1] < 0
        ? (t.translate(a, u),
          t.scale(c[0], c[1]),
...
class ja extends za {
  ...
  draw_(e, n, i) {
    if (
      ...
      r === null && (r = it), (n.fillStyle = $t(r)), n.fill();
    }
    e.strokeStyle &&
...
class yd {
  ...
  setScale(e) {
    (this.scale_ = e), (this.scaleArray_ = pt(e !== void 0 ? e : 1));
  }
  setStroke(e) {
    this.stroke_ = e;
  }
    ...
    function (r, s, o, l) {
      if (r !== void 0) {
        const a = t[0],
          u = t[t.length - 1],
          c = n ? Ed(a, n, o, i) : a;
        if (l) return e ? wd(r, c, u) : Se(r, u, c);
        const h = Math.min(c, r),
          d = Math.floor(Hh(t, h, s));
        return t[d] > c && d < t.length - 1 ? t[d + 1] : t[d];
      }
    }
  );
}
function wE(t, e, n, i, r, s) {
  return (
    (i = i !== void 0 ? i : !0),
    (n = n !== void 0 ? n : 0),
    function (o, l, a, u) {
      if (o !== void 0) {
        const c = r ? Ed(e, r, a, s) : e;
        if (u) return i ? wd(o, c, n) : Se(o, n, c);
        const h = 1e-9,
...
function Eg(t, e, n, i, r) {
  return (
    ...
    function (s, o, l, a) {
      if (s !== void 0) {
        const u = i ? Ed(t, i, l, r) : t;
        return !n || !a ? Se(s, e, u) : wd(s, u, e);
      }
    }
  );
}
...
class TE extends nn {
  constructor(e) {
    super(),
      ...
      (this.projection_ = rd(e.projection, "EPSG:3857")),
  ...
  getCenter() {
    ...
    return e && Wc(e, this.getProjection());
  }
  getCenterInternal() {
  ...
  calculateExtent(e) {
    ...
    return jc(n, this.getProjection());
  }
  calculateExtentInternal(e) {
    ...
    return Q(r !== void 0, "The view rotation is not defined"), Dc(n, i, r, e);
  }
  getMaxResolution() {
  ...
  getZoomForResolution(e) {
    ...
    if (this.resolutions_) {
      const s = Hh(this.resolutions_, e, 1);
      (n = s),
  ...
  fit(e, n) {
    ...
    if (
      ...
      (i = ug(r)), i.rotate(this.getRotation(), ci(r));
    } else {
      const r = S_();
  ...
  adjustCenter(e) {
    const n = Wc(this.targetCenter_, this.getProjection());
...
function IE(t) {
  if (t.extent !== void 0) {
    ...
    return vg(t.extent, t.constrainOnlyCenter, n);
  }
  const e = rd(t.projection, "EPSG:3857");
  if (t.multiWorld !== !0 && e.isGlobal()) {
    const n = e.getExtent().slice();
    return (n[0] = -1 / 0), (n[2] = 1 / 0), vg(n, !1, !1);
  }
  return vE;
}
function LE(t) {
...
class ME extends B_ {
  ...
  isVisible(e) {
    ...
    return Cd(r, n.viewState) && (!s || rt(s, n.extent));
  }
  getAttributions(e) {
...
let K_ = class {
  ...
  _build(e, n, i, r) {
    ...
    xg(e, n, i, u, this.compareMinX);
    for (let c = n; c <= i; c += u) {
      const h = Math.min(c + u - 1, i);
      xg(e, c, h, a, this.compareMinY);
      for (let d = c; d <= h; d += a) {
  ...
  _chooseSplitAxis(e, n, i) {
    const r = e.leaf ? this.compareMinX : DE,
      s = e.leaf ? this.compareMinY : NE,
...
class Ba extends za {
  constructor(e) {
    ...
    if (
      ...
      (this.iconImage_ = BE(o, l, this.crossOrigin_, a, this.color_)),
      ...
      if (e.size) [u, c] = e.size;
        ...
        if (h.width && h.height) (u = h.width), (c = h.height);
          ...
          const d = () => {
            ...
            this.setScale(Sg(f[0], f[1], e.width, e.height));
          };
          this.listenImageChange(d);
          return;
        }
      }
      u !== void 0 && this.setScale(Sg(u, c, e.width, e.height));
    }
  }
  clone() {
    let e, n, i;
...
const Jr = 0,
  ...
  VE = Object.keys(Z_).map(Number).sort(ai);
function Ue(t) {
  const e = [];
  for (const n of VE) bE(t, n) && e.push(Z_[n]);
  return e.length === 0
    ? "untyped"
    : e.length < 3
      ? e.join(" or ")
...
function ne(t, e, n) {
  switch (typeof t) {
    ...
    case "string": {
      let r = Wt;
      return oE(t) && (r |= Xe), Va(r & n, Jr) || (r &= n), new Hn(r, t);
    }
  }
  if (!Array.isArray(t))
    throw new Error("Expression must be an array or a primitive value");
  if (t.length === 0) throw new Error("Empty expression");
  if (typeof t[0] == "string") return sw(t, e, n);
  for (const r of t)
...
const I = {
  ...
  HE = {
    [I.Get]: Y(([t, e]) => (e !== void 0 ? ZE(e.value) : Qe), K(1, 2), $E),
    [I.Var]: Y(([t]) => t.type, K(1, 1), qE),
    [I.Id]: Y(N | Wt, ms, QE),
...
function ow(t, e) {
  const n = t.operator,
    i = t.args.length,
    r = new Array(i);
  for (let s = 0; s < i; ++s) r[s] = In(t.args[s]);
  switch (n) {
    case I.Number:
    case I.String:
      return (s) => {
...
function hw(t, e) {
  const n = t.args.length,
    i = new Array(n);
  for (let r = 0; r < n; ++r) i[r] = In(t.args[r]);
  return (r) => {
    const s = i[0](r);
...
function dw(t, e) {
  ...
  return (r) => {
    ...
    for (let u = 2; u < n; u += 2) {
      ...
      if ((d && (h = rE(h)), c >= o))
        return u === 2 ? h : d ? fw(s, o, l, a, c, h) : Cs(s, o, l, a, c, h);
      (l = c), (a = h);
    }
    return a;
  };
...
function Tg(t) {
  const e = H_(),
    n = t.length,
    i = new Array(n);
  for (let o = 0; o < n; ++o) i[o] = Zc(t[o], e);
  const r = $_(),
    s = new Array(n);
  return function (o, l) {
    if (
...
function mw(t, e) {
  ...
  for (let r = 0; r < n; ++r) {
    const s = t[r],
      o = "filter" in s ? _i(s.filter, Ee, e) : gw;
    let l;
    if (Array.isArray(s.style)) {
      const a = s.style.length;
      l = new Array(a);
      for (let u = 0; u < a; ++u) l[u] = Zc(s.style[u], e);
    } else l = [Zc(s.style, e)];
...
function uo(t, e, n) {
  const i = st(t, e + "stroke-width", n),
    r = q_(t, e + "stroke-color", n);
  if (!i && !r) return null;
  const s = Un(t, e + "stroke-line-cap", n),
    o = Un(t, e + "stroke-line-join", n),
    l = Q_(t, e + "stroke-line-dash", n),
    a = st(t, e + "stroke-line-dash-offset", n),
    u = st(t, e + "stroke-miter-limit", n),
    c = new Na();
  return function (h) {
    if (r) {
      const d = r(h);
...
function _w(t, e) {
  ...
  const r = ao(t, n, e),
    ...
    a = Un(t, n + "font", e),
    u = st(t, n + "max-angle", e),
    c = st(t, n + "offset-x", e),
    h = st(t, n + "offset-y", e),
    d = co(t, n + "overflow", e),
    f = Un(t, n + "placement", e),
    m = st(t, n + "repeat", e),
    y = ba(t, n + "scale", e),
...
function vw(t, e) {
  const n = "icon-",
    ...
    h = Ig(t, n + "anchor-origin"),
    d = Lg(t, n + "anchor-x-units"),
    f = Lg(t, n + "anchor-y-units"),
    m = Rw(t, n + "color"),
    y = Cw(t, n + "cross-origin"),
    v = Sw(t, n + "offset"),
    p = Ig(t, n + "offset-origin"),
    g = Sr(t, n + "width"),
    _ = Sr(t, n + "height"),
    E = xw(t, n + "size"),
    w = Sd(t, n + "declutter"),
...
function xw(t, e) {
  const n = t[e];
  if (n !== void 0) {
    if (typeof n == "number") return pt(n);
    if (!Array.isArray(n))
...
const kg = { RENDER_ORDER: "renderOrder" };
class Iw extends Ya {
  constructor(e) {
    e = e || {};
    const n = Object.assign({}, e);
  ...
  getRenderOrder() {
    return this.get(kg.RENDER_ORDER);
  }
  getStyle() {
    return this.style_;
  }
  ...
  setRenderOrder(e) {
    this.set(kg.RENDER_ORDER, e);
  }
  setStyle(e) {
    (this.style_ = Lw(e)),
      (this.styleFunction_ = e === null ? void 0 : pE(this.style_)),
      this.changed();
  }
}
function Lw(t) {
  if (t === void 0) return mE;
  if (!t) return null;
...
class So extends n0 {
  ...
  drawCustom(e, n, i, r) {
    ...
    switch (s) {
      case "MultiPolygon":
        ...
        this.instructions.push([z.CUSTOM, l, h, e, i, Xc]),
          this.hitDetectionInstructions.push([z.CUSTOM, l, h, e, r || i, Xc]);
        break;
      case "Polygon":
    ...
    for (n = 0; n < i; ++n)
      (r = e[n]),
        ...
        s == z.END_GEOMETRY
          ? (o = n)
          : s == z.BEGIN_GEOMETRY &&
            ((r[2] = n), H1(this.hitDetectionInstructions, o, n), (o = -1));
  }
  setFillStrokeStyle(e, n) {
    const i = this.state;
    if (e) {
    ...
    if (n) {
      ...
      i.lineDash = o ? o.slice() : vn;
      const l = n.getLineDashOffset();
      i.lineDashOffset = l || En;
  ...
  getBufferedMaxExtent() {
    if (
      ...
      Qh(this.bufferedMaxExtent_, e, this.bufferedMaxExtent_);
    }
...
class Ow extends So {
  ...
  drawFlatCoordinatess_(e, n, i, r) {
    ...
    for (let u = 0; u < a; ++u) {
      ...
      this.instructions.push(f),
        ...
        l &&
          (this.instructions.push(Pg), this.hitDetectionInstructions.push(Pg)),
        (n = c);
    }
    return (
  ...
  drawCircle(e, n) {
    ...
    this.setFillStrokeStyles_(),
      this.beginGeometry(e, n),
      i.fillStyle !== void 0 &&
        this.hitDetectionInstructions.push([z.SET_FILL_STYLE, it]),
      i.strokeStyle !== void 0 &&
        this.hitDetectionInstructions.push([
          z.SET_STROKE_STYLE,
          i.strokeStyle,
...
class Nw extends So {
  constructor(e, n, i, r) {
    super(e, n, i, r),
      ...
      (this.fillStates = {}),
      (this.fillStates[it] = { fillStyle: it }),
  ...
  drawText(e, n) {
    ...
    if (
      ...
      if (!rt(this.getBufferedMaxExtent(), e.getExtent())) return;
      let h;
      ...
      for (let y = 0, v = h.length; y < v; ++y) {
        let p;
        d
          ? (p = Fw(d * this.resolution, u, m, h[y], c))
          : (p = [u.slice(m, h[y])]);
        for (let g = 0, _ = p.length; g < _; ++g) {
          ...
          let w = 0,
            x = E.length;
          if (f == null) {
            const S = Dw(s.maxAngle, E, 0, E.length, 2);
            (w = S[0]), (x = S[1]);
          }
    ...
    if (!e) this.text_ = "";
      ...
      if (!l) (s = null), (this.textStrokeState_ = s);
        ...
        (s.lineCap = l.getLineCap() || Vr),
          (s.lineDash = m ? m.slice() : vn),
          (s.lineDashOffset = y === void 0 ? En : y),
...
class r0 extends Gw {
  ...
  getRenderTransform(e, n, i, r, s, o, l) {
    const a = s / 2,
      ...
      d = -e[0] + l,
      f = -e[1];
    return Rn(this.tempTransform, a, u, c, h, -i, d, f);
  }
  disposeInternal() {
    delete this.frameState, super.disposeInternal();
  }
}
function jw(t, e, n, i, r, s, o, l, a, u, c, h) {
  let d = t[e],
    f = t[e + 1],
    m = 0,
    y = 0,
...
const Dg = new RegExp("[֑-ࣿיִ-﷿ﹰ-ﻼࠀ-࿿-]");
function Mu(t, e) {
  return (
    e === "start"
      ? (e = Dg.test(t) ? "right" : "left")
      : e === "end" && (e = Dg.test(t) ? "left" : "right"),
    sa[e]
  );
}
function Xw(t, e, n) {
...
`,
            ...
            .reduce(Xw, []),
      { width: y, height: v, widths: p, heights: g, lineWidths: _ } = dE(a, m),
      E = y + f,
      w = [],
      x = (E + 2) * c[0],
      C = (v + f) * c[1],
...
`
  ...
  calculateImageOrLabelDimensions_(
    ...
    return (
      h !== 0
        ? ((M = Rn(Ut(), i, r, 1, 1, h, -i, -r)),
          ke(M, Fn),
          ke(M, un),
          ke(M, cn),
          ke(M, Dn),
          Tn(
            Math.min(Fn[0], un[0], cn[0], Dn[0]),
            Math.min(Fn[1], un[1], cn[1], Dn[1]),
            Math.max(Fn[0], un[0], cn[0], Dn[0]),
            Math.max(Fn[1], un[1], cn[1], Dn[1]),
            ir,
          ))
        : Tn(
            Math.min(C, C + w),
  ...
  replayImageOrLabel_(e, n, i, r, s, o, l) {
    ...
    return (
      u.minX - h <= c.width / n &&
        ...
        u.minY - h <= c.height / n &&
        u.maxY + h >= 0 &&
        (a && this.replayTextBackground_(e, Fn, un, cn, Dn, o, l),
        fE(
          e,
          r.canvasTransform,
          s,
    ...
    for (; c < h; ) {
      ...
      switch (T[0]) {
        ...
        case z.CUSTOM:
          ...
          Lo
            ? Lo(u, d, f, 2, Pn)
            : ((Pn[0] = u[d]), (Pn[1] = u[d + 1]), (Pn.length = 2)),
            Hi(Pn, D),
            ++c;
          break;
        case z.DRAW_IMAGE:
          ...
          if (!E && T.length >= 20) {
            ...
            const ct = this.drawLabelWithPointPlacement_(w, x, C, S);
            (E = ct.label), (T[3] = E);
            const Ji = T[23];
            (m = (ct.anchorX - Ji) * this.pixelRatio), (T[4] = m);
            const xt = T[24];
            (y = (ct.anchorY - xt) * this.pixelRatio),
              (T[5] = y),
              (ts = E.height),
              (T[6] = ts),
              ($e = E.width),
          ...
          for (; d < f; d += 2) {
            ...
            const ct = this.calculateImageOrLabelDimensions_(
              ...
              Ji = [e, n, E, ct, Mn, yi ? j : null, An ? Z : null];
            if (a) {
              if (wt === "none") continue;
              if (wt === "obstacle") {
                a.insert(ct.declutterBox);
                continue;
              } else {
                let xt, ln;
                if (At) {
                ...
                if (a.collides(ct.declutterBox)) continue;
                xt && (a.insert(ln), this.replayImageOrLabel_.apply(this, xt)),
                  a.insert(ct.declutterBox);
              }
            }
        ...
        case z.DRAW_CHARS:
          ...
          const zd = [T[13], T[13]],
            ...
            ns = qa.font,
            is = [qa.scale[0] * Dd, qa.scale[1] * Dd];
          let rs;
          ns in this.widths_
            ? (rs = this.widths_[ns])
            : ((rs = {}), (this.widths_[ns] = rs));
          const Gd = N_(u, Ao, Be, 2),
            Wd = Math.abs(is[0]) * _g(ns, w, rs);
          if (T0 || Wd <= Gd) {
            const ct = this.textStates[x].textAlign,
              Ji = (Gd - Wd) * Mu(w, ct),
              xt = jw(
                u,
                Ao,
            ...
            e: if (xt) {
              ...
              let ht, Oo, Fo, qe, Ct;
              if (C)
                for (ht = 0, Oo = xt.length; ht < Oo; ++ht) {
                  (Ct = xt[ht]),
                    (Fo = Ct[4]),
              ...
              a && a.load(ln.map(Fg));
              for (let an = 0, L0 = ln.length; an < L0; ++an)
...
class Ng {
  ...
  createExecutors_(e) {
    for (const n in e) {
      ...
      for (const s in r) {
        const o = r[s];
        i[s] = new Uw(this.resolution_, this.pixelRatio_, this.overlaps_, o);
      }
    }
  }
  hasExecutors(e) {
  ...
  forEachFeatureAtCoordinate(e, n, i, r, s, o) {
    ...
    this.renderBuffer_ !== void 0 &&
      ((h = Pt()), Os(h, e), Qh(h, n * (this.renderBuffer_ + r), h));
    const d = Yw(r);
    let f;
    function m(w, x) {
...
class Bw extends n0 {
  constructor(e, n, i, r, s, o, l) {
    super(),
      ...
      (this.extent_ = i),
      (this.transform_ = r),
      (this.transformRotation_ = r ? td(Math.atan2(r[1], r[0]), 10) : 0),
  ...
  drawCircle(e) {
    if (
      ...
      if (this.fillState_ || this.strokeState_) {
        ...
        const n = Wv(e, this.transform_, this.pixelCoordinates_),
          i = n[2] - n[0],
          r = n[3] - n[1],
          s = Math.sqrt(i * i + r * r),
          o = this.context_;
  ...
  setFillStrokeStyle(e, n) {
    if (!e) this.fillState_ = null;
      ...
      const i = e.getColor();
      this.fillState_ = { fillStyle: $t(i || it) };
    }
    if (!n) this.strokeState_ = null;
      ...
      this.strokeState_ = {
        ...
        lineDashOffset: (o || En) * this.pixelRatio_,
  ...
  setTextStyle(e) {
    if (!e) this.text_ = "";
      ...
      if (!n) this.textFillState_ = null;
        ...
        const f = n.getColor();
        this.textFillState_ = { fillStyle: $t(f || it) };
      }
      const i = e.getStroke();
...
const Zt = 0.5;
function Vw(t, e, n, i, r, s, o) {
  const l = t[0] * Zt,
    a = t[1] * Zt,
    u = Ke(l, a);
  u.imageSmoothingEnabled = !1;
  const c = u.canvas,
    h = new Bw(u, Zt, r, null, o),
    d = n.length,
  ...
  for (let v = 1; v <= d; ++v) {
    ...
    for (let x = 0, C = _.length; x < C; ++x) {
      ...
      if (!M || !rt(r, M.getExtent())) continue;
      const k = S.clone(),
        j = k.getFill();
      j && j.setColor(w);
      const Z = k.getStroke();
...
function zg(t, e, n, i, r, s, o) {
  ...
  return qw(t, e, n, i, s, o), l;
}
function qw(t, e, n, i, r, s) {
...
class sx extends r0 {
  ...
  setupCompositionContext_() {
    if (this.opacity_ !== 1) {
      const e = Ke(this.context.canvas.width, this.context.canvas.height, Og);
  ...
  releaseCompositionContext_() {
    if (this.opacity_ !== 1) {
      ...
      (this.context.globalAlpha = this.opacity_),
        ...
        Og.push(this.compositionContext_.canvas),
        (this.compositionContext_ = null);
    }
  }
  renderDeclutter(e) {
  ...
  renderFrame(e, n) {
    ...
    sv(this.pixelTransform, 1 / i, 1 / i),
  ...
  getFeatures(e) {
    return new Promise((n) => {
      if (!this.hitDetectionImageData_ && !this.animatingOrInteracting_) {
        ...
        this.hitDetectionImageData_ = Vw(
          i,
          c,
      ...
      n(bw(e, this.renderedFeatures_, this.hitDetectionImageData_));
    });
  }
  forEachFeatureAtCoordinate(e, n, i, r, s) {
  ...
  prepareFrame(e) {
    ...
    this.replayGroup_ = null;
    const w = new Ag(Hc(h, d), p, h, d);
    let x;
    this.getLayer().getDeclutter() && (x = new Ag(Hc(h, d), p, h, d));
    const C = S_();
    let S;
    if (C) {
    ...
    const he = w.finish(),
      U = new Ng(p, h, d, i.getOverlaps(), he, n.getRenderBuffer());
    return (
      x &&
        (this.declutterExecutorGroup = new Ng(
          p,
          h,
          d,
          i.getOverlaps(),
  ...
  renderFeature(e, n, i, r, s, o) {
    ...
    if (Array.isArray(i))
      for (let a = 0, u = i.length; a < u; ++a)
        l = zg(r, e, i[a], n, this.boundHandleStyleImageChange_, s, o) || l;
    else l = zg(r, e, i, n, this.boundHandleStyleImageChange_, s, o);
    return l;
  }
}
class ox extends Iw {
...
class Gg {
  ...
  getExtent(e) {
    ...
    return Tn(n.minX, n.minY, n.maxX, n.maxY, e);
  }
  concat(e) {
...
class la extends bi {
  ...
  intersectsExtent(e) {
    return Zv(this.flatCoordinates, 0, this.ends_, this.stride, e);
  }
  setCoordinates(e, n) {
    this.setLayout(n, e, 2),
      this.flatCoordinates || (this.flatCoordinates = []);
...
class aa extends bi {
  ...
  closestPointXY(e, n, i, r) {
    return r < Bi(this.getExtent(), e, n)
      ...
      : (this.maxDeltaRevision_ != this.getRevision() &&
          ((this.maxDelta_ = Math.sqrt(
            jv(this.flatCoordinates, 0, this.endss_, this.stride, 0),
          )),
          (this.maxDeltaRevision_ = this.getRevision())),
        Xv(
          this.getOrientedFlatCoordinates(),
  ...
  getArea() {
    return Vv(this.getOrientedFlatCoordinates(), 0, this.endss_, this.stride);
  }
  getCoordinates(e) {
    let n;
    return (
      e !== void 0
        ? ((n = this.getOrientedFlatCoordinates().slice()),
          Uc(n, 0, this.endss_, this.stride, e))
        : (n = this.flatCoordinates),
      Xc(n, 0, this.endss_, this.stride)
    );
  }
  getEndss() {
    return this.endss_;
  ...
  getOrientedFlatCoordinates() {
    if (this.orientedRevision_ != this.getRevision()) {
      ...
      D_(e, 0, this.endss_, this.stride)
        ? (this.orientedFlatCoordinates_ = e)
        : ((this.orientedFlatCoordinates_ = e.slice()),
          (this.orientedFlatCoordinates_.length = Uc(
            this.orientedFlatCoordinates_,
            0,
            this.endss_,
            this.stride,
...
class et {
      ...
      this.extent_ ||
        (this.extent_ =
          this.type_ === "Point"
            ...
            : ed(this.flatCoordinates_, 0, this.flatCoordinates_.length, 2)),
      this.extent_
    );
  }
  getFlatInteriorPoint() {
  ...
  getFlatInteriorPoints() {
    if (!this.flatInteriorPoints_) {
      const e = qv(this.flatCoordinates_, this.ends_),
  ...
  enableSimplifyTransformed() {
    return (
      (this.simplifyTransformed = l_((e, n) => {
        ...
        return (
          r &&
            (this.simplifiedGeometry_ = new et(
              this.type_,
              i,
              r,
              2,
...
et.prototype.getFlatCoordinates = et.prototype.getOrientedFlatCoordinates;
class u0 extends nn {
  constructor(e) {
    super(),
...
class gx extends u0 {
    ...
    (e = e || {}),
      ...
      e.loader !== void 0
        ...
        : this.url_ !== void 0 &&
          ...
          (this.loader_ = Ug(this.url_, this.format_))),
      (this.strategy_ = e.strategy !== void 0 ? e.strategy : hx);
    const n = e.useSpatialIndex !== void 0 ? e.useSpatialIndex : !0;
    (this.featuresRtree_ = n ? new Gg() : null),
      (this.loadedExtentsRtree_ = new Gg()),
  ...
  addFeatureInternal(e) {
    ...
    this.dispatchEvent(new Nn(Dt.ADDFEATURE, e));
  }
  ...
  addFeaturesInternal(e) {
    ...
    if (
      ...
      for (let s = 0, o = i.length; s < o; s++)
        this.dispatchEvent(new Nn(Dt.ADDFEATURE, i[s]));
  }
  bindFeaturesCollection_(e) {
    ...
    this.addEventListener(Dt.ADDFEATURE, function (i) {
      ...
      e.addEventListener(nt.ADD, (i) => {
        n || ((n = !0), this.addFeature(i.element), (n = !1));
      }),
      e.addEventListener(nt.REMOVE, (i) => {
  ...
  forEachFeatureAtCoordinateDirect(e, n) {
    ...
    return this.forEachFeatureInExtent(i, function (r) {
      ...
      if (s instanceof et || s.intersectsCoordinate(e)) return n(r);
    });
  }
  ...
  forEachFeatureIntersectingExtent(e, n) {
    return this.forEachFeatureInExtent(e, function (i) {
      ...
      if (r instanceof et || r.intersectsExtent(e)) {
        const s = n(i);
        if (s) return s;
      }
    });
      ...
      this.featuresRtree_.forEachInExtent(a, function (u) {
        if (n(u)) {
          const c = u.getGeometry(),
            h = l;
          if (
            ((l = c instanceof et ? 0 : c.closestPointXY(i, r, o, l)), l < h)
          ) {
            s = u;
            const d = Math.sqrt(l);
  ...
  handleFeatureChange_(e) {
    ...
    this.changed(), this.dispatchEvent(new Nn(Dt.CHANGEFEATURE, n));
  }
  hasFeature(e) {
    const n = e.getId();
  ...
  loadFeatures(e, n, i) {
    ...
    for (let o = 0, l = s.length; o < l; ++o) {
      ...
      r.forEachInExtent(a, function (c) {
        ...
        this.dispatchEvent(new Nn(Dt.FEATURESLOADSTART)),
        this.loader_.call(
          this,
          a,
          n,
          ...
          (c) => {
            --this.loadingExtentsCount_,
              this.dispatchEvent(new Nn(Dt.FEATURESLOADEND, void 0, c));
          },
          () => {
            --this.loadingExtentsCount_,
              this.dispatchEvent(new Nn(Dt.FEATURESLOADERROR));
          },
        ),
  ...
  removeFeatureInternal(e) {
    ...
    return (
      ...
      this.dispatchEvent(new Nn(Dt.REMOVEFEATURE, e)),
      e
    );
  }
  removeFromIdIndex_(e) {
    ...
    for (const i in this.idIndex_) {
      ...
      if (e instanceof et && Array.isArray(r) && r.includes(e))
  ...
  setUrl(e) {
    Q(this.format_, "`format` must be set when `url` is set"),
      (this.url_ = e),
      this.setLoader(Ug(e, this.format_));
  }
}
const px = gx,
...
class yx extends Zh {
  ...
  forEachFeatureAtCoordinate(e, n, i, r, s, o, l, a) {
    ...
    for (let E = 0; E < m.length; E++)
      for (let w = v - 1; w >= 0; --w) {
        const x = y[w],
          C = x.layer;
        if (C.hasRenderer() && Cd(x, c) && l.call(a, C)) {
  ...
  scheduleExpireIconCache(e) {
    ia.canExpireCache() && e.postRenderFunctions.push(vx);
  }
}
function vx(t, e) {
  ia.expire();
...
class Ex extends yx {
  ...
  renderFrame(e) {
    ...
    this.flushDeclutterItems(e),
      aE(this.element_, this.children_),
...
class es extends B_ {
  ...
  handleLayersChanged_() {
    ...
    this.layersListenerKeys_.push(
      $(e, nt.ADD, this.handleLayersAdd_, this),
      $(e, nt.REMOVE, this.handleLayersRemove_, this),
    );
    ...
    for (let i = 0, r = n.length; i < r; i++) {
      ...
      this.registerLayerListeners_(s),
        this.dispatchEvent(new Yn("addlayer", s));
    }
    this.changed();
  }
  ...
  handleLayersAdd_(e) {
    ...
    this.registerLayerListeners_(n),
      this.dispatchEvent(new Yn("addlayer", n)),
      this.changed();
  }
  handleLayersRemove_(e) {
    ...
    this.listenerKeys_[i].forEach(ce),
      ...
      this.dispatchEvent(new Yn("removelayer", n)),
      this.changed();
  }
  getLayers() {
...
class wx extends Ta {
  ...
  emulateClick_(e) {
    let n = new Gn(_e.CLICK, this.map_, e);
    this.dispatchEvent(n),
      this.clickTimeoutId_ !== void 0
        ? (clearTimeout(this.clickTimeoutId_),
          (this.clickTimeoutId_ = void 0),
          (n = new Gn(_e.DBLCLICK, this.map_, e)),
          this.dispatchEvent(n))
        : (this.clickTimeoutId_ = setTimeout(() => {
            this.clickTimeoutId_ = void 0;
            const i = new Gn(_e.SINGLECLICK, this.map_, e);
  ...
  relayMoveEvent_(e) {
    ...
    this.dispatchEvent(new Gn(_e.POINTERMOVE, this.map_, e, n));
  }
  handleTouchMove_(e) {
...
class Td extends nn {
  ...
  disposeInternal() {
    Vc(this.element), super.disposeInternal();
  }
  getMap() {
    return this.map_;
  }
  setMap(e) {
    this.map_ && Vc(this.element);
    ...
    (this.listenerKeys.length = 0),
      ...
      e &&
        ...
        this.render !== Ur &&
          this.listenerKeys.push($(e, Wn.POSTRENDER, this.render, this)),
        e.render());
  }
  render(e) {}
  setTarget(e) {
...
class Rx extends Td {
  constructor(e) {
    ...
    const u =
        ...
        " " +
        _d +
        (this.collapsed_ && this.collapsible_ ? " " + pg : "") +
  ...
  handleToggle_() {
    this.element.classList.toggle(pg),
      this.collapsed_
        ? gg(this.collapseLabel_, this.label_)
        : gg(this.label_, this.collapseLabel_),
...
function Mx(t) {
  ...
  const e = new Ht();
  return (
    (t.zoom !== void 0 ? t.zoom : !0) && e.push(new Px(t.zoomOptions)),
    (t.rotate !== void 0 ? t.rotate : !0) && e.push(new Lx(t.rotateOptions)),
    (t.attribution !== void 0 ? t.attribution : !0) &&
      e.push(new Tx(t.attributionOptions)),
    e
  );
}
const Yg = { ACTIVE: "active" };
class Ro extends nn {
  constructor(e) {
    super(),
      this.on,
  ...
  handleEvent(e) {
    ...
    if (e.type == _e.DBLCLICK) {
      const i = e.originalEvent,
        ...
        l = r.getView();
      Id(l, o, s, this.duration_), i.preventDefault(), (n = !0);
    }
    return !n;
  }
}
...
const Dx = function (t) {
  ...
  d0 = function (t) {
    return t.map.getTargetElement().hasAttribute("tabindex") ? Nx(t) : !0;
  },
  zx = Qs,
  f0 = function (t) {
    const e = t.originalEvent;
    return e.button == 0 && !(nv && a_ && e.ctrlKey);
  },
  g0 = function (t) {
    const e = t.originalEvent;
    return !e.altKey && !(e.metaKey || e.ctrlKey) && !e.shiftKey;
...
class Xx extends To {
  constructor(e) {
    super({ stopDown: Ra }),
      ...
      (this.panning_ = !1);
    const n = e.condition ? e.condition : qc(g0, jx);
...
class Yx extends To {
  constructor(e) {
    (e = e || {}),
      super({ stopDown: Ra }),
      (this.condition_ = e.condition ? e.condition : Dx),
  ...
  handleDragEvent(e) {
    ...
    const n = e.map,
      i = n.getView();
    if (i.getConstraints().rotation === xd) return;
    const r = n.getSize(),
      s = e.pixel,
...
class Vx extends To {
  constructor(e) {
    super(),
      ...
      this.un,
      (e = e || {}),
      (this.box_ = new Bx(e.className || "ol-dragbox")),
    ...
    if (e.type == V.KEYDOWN || e.type == V.KEYPRESS) {
      ...
      if (this.condition_(e) && (r === "+" || r === "-")) {
        const s = e.map,
          ...
          l = s.getView();
        Id(l, o, void 0, this.duration_), i.preventDefault(), (n = !0);
      }
    }
    return !n;
  }
...
class qx extends Ro {
  constructor(e) {
    ...
    const n = e.condition ? e.condition : zx;
  ...
  handleEvent(e) {
    ...
    if (
      (e.type == V.WHEEL &&
        ((s = r.deltaY),
        ev && r.deltaMode === WheelEvent.DOM_DELTA_PIXEL && (s /= u_),
  ...
  handleWheelZoom_(e) {
    ...
    (n.getConstrainResolution() || this.constrainResolution_) &&
      (i = i ? (i > 0 ? 1 : -1) : 0),
      Id(n, i, this.lastAnchor_, this.duration_),
      (this.mode_ = void 0),
      (this.totalDelta_ = 0),
      (this.lastAnchor_ = null),
      (this.startTime_ = void 0),
...
class Jx extends To {
  ...
  handleDragEvent(e) {
    ...
    const o = e.map,
      l = o.getView();
    l.getConstraints().rotation !== xd &&
      ((this.anchor_ = o.getCoordinateFromPixelInternal(
        o.getEventPixel(Ld(this.targetPointers)),
      )),
      this.rotating_ &&
  ...
  handleDragEvent(e) {
    ...
    n != 1 && (this.lastScaleDelta_ = n),
      (this.anchor_ = a.getCoordinateFromPixelInternal(
        a.getEventPixel(Ld(this.targetPointers)),
      )),
      a.render(),
...
function nC(t) {
  t = t || {};
  const e = new Ht(),
    n = new _x(-0.005, 0.05, 100);
  return (
    (t.altShiftDragRotate !== void 0 ? t.altShiftDragRotate : !0) &&
      e.push(new Yx()),
    (t.doubleClickZoom !== void 0 ? t.doubleClickZoom : !0) &&
      e.push(new Fx({ delta: t.zoomDelta, duration: t.zoomDuration })),
    (t.dragPan !== void 0 ? t.dragPan : !0) &&
      e.push(new Ux({ onFocusOnly: t.onFocusOnly, kinetic: n })),
    (t.pinchRotate !== void 0 ? t.pinchRotate : !0) && e.push(new Jx()),
    (t.pinchZoom !== void 0 ? t.pinchZoom : !0) &&
      e.push(new tC({ duration: t.zoomDuration })),
    (t.keyboard !== void 0 ? t.keyboard : !0) &&
      (e.push(new Zx()),
      e.push(new $x({ delta: t.zoomDelta, duration: t.zoomDuration }))),
    (t.mouseWheelZoom !== void 0 ? t.mouseWheelZoom : !0) &&
      e.push(new Qx({ onFocusOnly: t.onFocusOnly, duration: t.zoomDuration })),
    (t.shiftDragZoom !== void 0 ? t.shiftDragZoom : !0) &&
      e.push(new Kx({ duration: t.zoomDuration })),
    e
  );
}
function m0(t) {
...
let iC = class extends nn {
  constructor(e) {
    ...
    this.renderComplete_,
      ...
      (this.controls = n.controls || Mx()),
      (this.interactions = n.interactions || nC({ onFocusOnly: !0 })),
      (this.overlays_ = n.overlays),
      (this.overlayIdIndex_ = {}),
      (this.renderer_ = null),
      (this.postRenderFunctions_ = []),
      (this.tileQueue_ = new Cx(
    ...
    e.view &&
      ...
      this.controls.addEventListener(nt.ADD, (r) => {
        r.element.setMap(this);
      }),
      this.controls.addEventListener(nt.REMOVE, (r) => {
        r.element.setMap(null);
      }),
      this.interactions.addEventListener(nt.ADD, (r) => {
        r.element.setMap(this);
      }),
      this.interactions.addEventListener(nt.REMOVE, (r) => {
        r.element.setMap(null);
      }),
      this.overlays_.addEventListener(nt.ADD, (r) => {
        this.addOverlayInternal_(r.element);
      }),
      this.overlays_.addEventListener(nt.REMOVE, (r) => {
  ...
  getTilePriority(e, n, i, r) {
    return Sx(this.frameState_, e, n, i, r);
  }
  ...
  handleMapBrowserEvent(e) {
    ...
    const n = e.originalEvent,
      i = n.type;
    if (i === $c.POINTERDOWN || i === V.WHEEL || i === V.KEYDOWN) {
    ...
    e &&
      ...
      (this.renderComplete_ === !0
        ? (this.hasListener(en.RENDERCOMPLETE) &&
          ...
          this.loaded_ === !1 &&
            ((this.loaded_ = !0),
            this.dispatchEvent(new ur(Wn.LOADEND, this, e))))
        : this.loaded_ === !0 &&
          ((this.loaded_ = !1),
          this.dispatchEvent(new ur(Wn.LOADSTART, this, e))));
  ...
  handleTargetChanged_() {
    ...
    if (((this.targetElement_ = n), !n))
      ...
      n.appendChild(this.viewport_),
        this.renderer_ || (this.renderer_ = new Ex(this)),
        (this.mapBrowserEventHandler_ = new wx(this, this.moveTolerance_));
      for (const s in _e)
  ...
  handleLayerGroupChanged_() {
    ...
    e &&
      (this.handleLayerAdd_(new Yn("addlayer", e)),
      (this.layerGroupPropertyListenerKeys_ = [
    ...
    if (n !== void 0 && cg(n) && i && i.isDef()) {
      ...
      if (
        ((s = {
          ...
          declutterTree: null,
          extent: Dc(l.center, l.resolution, l.rotation, n),
        ...
        s.nextExtent = Dc(l.nextCenter, l.nextResolution, a, n);
      }
    }
    (this.frameState_ = s),
      ...
      s &&
        ...
        r &&
          ...
          (this.dispatchEvent(new ur(Wn.MOVESTART, this, r)),
          (this.previousExtent_ = $r(this.previousExtent_))),
        this.previousExtent_ &&
          !s.viewHints[We.ANIMATING] &&
          !s.viewHints[We.INTERACTING] &&
          !Js(s.extent, this.previousExtent_) &&
          (this.dispatchEvent(new ur(Wn.MOVEEND, this, s)),
          f_(s.extent, this.previousExtent_))),
      this.dispatchEvent(new ur(Wn.POSTRENDER, this, s)),
      (this.renderComplete_ =
        this.hasListener(Wn.LOADSTART) ||
        this.hasListener(Wn.LOADEND) ||
        this.hasListener(en.RENDERCOMPLETE)
  ...
  setLayerGroup(e) {
    const n = this.getLayerGroup();
    n && this.handleLayerRemove_(new Yn("removelayer", n)),
  ...
  constructor(e, n, i, r, s, o) {
    ...
    const u = Vi(i),
      ...
      p =
        dC +
        (o
          ? Math.max(0, Math.ceil(Math.log2(Fc(i) / (o * o * 256 * 256))))
          : 0);
  ...
  addQuad_(e, n, i, r, s, o, l, a, u) {
    ...
    if (u > 0) {
      if (this.targetProj_.isGlobal() && this.targetWorldWidth_) {
        const v = Jf([e, n, i, r]);
        m = oe(v) / this.targetWorldWidth_ > Vg || m;
      }
      !f && this.sourceProj_.isGlobal() && h && (m = h > Vg || m);
    }
    if (
      !m &&
...
function mC(t, e, n, i, r, s, o, l, a, u, c, h, d) {
  ...
  return (
    l.getTriangles().forEach(function (g, _, E) {
      ...
      if (v) (me = v.canvas), f.scale(i / n, -i / n);
        ...
        const B = a[0],
          te = B.extent;
        (me = B.image), f.scale(oe(te) / me.width, -_t(te) / me.height);
      }
...
class Qc extends c0 {
  constructor(e, n, i, r, s, o, l, a, u, c, h, d) {
    ...
    const E = c !== void 0 ? c : hC;
    if (
      ((this.triangulation_ = new fC(e, i, v, y, _ * E, g)),
...
class _C extends r0 {
  ...
  getData(e) {
    ...
    for (let d = c.getZForResolution(a.resolution); d >= c.getMinZoom(); --d) {
      ...
      if (
        !(m instanceof h0 || m instanceof Qc) ||
        (m instanceof Qc && m.getState() === G.EMPTY)
      )
        return null;
      if (m.getState() !== G.LOADED) continue;
      const y = c.getOrigin(d),
        v = pt(c.getTileSize(d)),
        p = c.getResolution(d),
  ...
  renderFrame(e, n) {
    ...
    this.newTiles_ = !1;
    const he = a ? Nc(r.center, p, a, e.size) : void 0;
    ...
    const F = this.context,
      R = F.canvas;
    qh(this.inversePixelTransform, this.pixelTransform),
      Rn(this.tempTransform, _ / 2, E / 2, U, U, 0, -_ / 2, -E / 2),
    ...
    for (let me = P.length - 1; me >= 0; --me) {
      ...
      for (const ts in Pn) {
        const Mn = Pn[ts],
          ...
          wt = Math.round(Hi[1] - $i * sn),
          At = Mo - $e,
          on = Za - wt,
          qi = m === B,
          yi = qi && Mn.getAlpha(ee(this), e.time) !== 1;
        let An = !1;
        if (!yi)
          if (A) {
            T = [$e, wt, $e + At, wt, $e + At, wt + on, $e, wt + on];
            for (let Qi = 0, Ao = A.length; Qi < Ao; ++Qi)
              if (m !== B && B < b[Qi]) {
                const Be = A[Qi];
                rt([$e, wt, $e + At, wt + on], [Be[0], Be[3], Be[4], Be[7]]) &&
                  (An || (F.save(), (An = !0)),
                  F.beginPath(),
                  F.moveTo(T[0], T[1]),
                  F.lineTo(T[2], T[3]),
            ...
            A.push(T), b.push(B);
          } else F.clearRect($e, wt, At, on);
        this.drawTileImage(Mn, e, $e, wt, At, on, Lo, qi),
          A && !yi
            ? (An && F.restore(), this.renderedTiles.unshift(Mn))
  ...
  manageTilePyramid(e, n, i, r, s, o, l, a, u) {
    ...
    const h = e.wantedTiles[c],
      ...
      y = m
        ? Nc(e.viewState.center, e.viewState.resolution, m, e.size)
        : void 0;
    let v = 0,
      p,
      g,
...
class vC {
  constructor(e) {
    ...
    i !== void 0 && !this.origin_ && !this.origins_ && (this.origin_ = Vi(i)),
      ...
      (this.tileSize_ =
        e.tileSize !== void 0 ? e.tileSize : this.tileSizes_ ? null : vd),
      Q(
  ...
  getTileCoordForXYAndResolution_(e, n, i, r, s) {
    const o = this.getZForResolution(i),
      ...
      a = this.getOrigin(o),
      u = pt(this.getTileSize(o), this.tmpSize_);
    let c = (l * (e - a[0])) / i / u[0],
      h = (l * (a[1] - n)) / i / u[1];
    return (
      r
        ? ((c = tl(c, zn) - 1), (h = tl(h, zn) - 1))
        : ((c = el(c, zn)), (h = el(h, zn))),
      Bg(o, c, h, s)
    );
  }
  getTileCoordForXYAndZ_(e, n, i, r, s) {
    const o = this.getOrigin(i),
      ...
      a = pt(this.getTileSize(i), this.tmpSize_);
    let u = (e - o[0]) / l / a[0],
      c = (o[1] - n) / l / a[1];
    return (
      r
        ? ((u = tl(u, zn) - 1), (c = tl(c, zn) - 1))
        : ((u = el(u, zn)), (c = el(c, zn))),
      Bg(i, u, c, s)
    );
  }
  ...
  getZForResolution(e, n) {
    const i = Hh(this.resolutions_, e, n || 0);
...
function x0(t) {
  ...
  return e || ((e = CC(t)), t.setDefaultTileGrid(e)), e;
}
function EC(t, e, n) {
  const i = e[0],
...
function wC(t, e, n, i) {
  ...
  const r = C0(t, e, n);
  return new w0({ extent: t, origin: uv(t, i), resolutions: r, tileSize: n });
}
function xC(t) {
  const e = t || {},
...
function C0(t, e, n, i) {
  (e = e !== void 0 ? e : yE), (n = pt(n !== void 0 ? n : vd));
  const r = _t(t),
    s = oe(t);
...
class SC extends u0 {
  constructor(e) {
    ...
    const n = [256, 256];
    this.tileGrid &&
      pt(this.tileGrid.getTileSize(this.tileGrid.getMinZoom()), n),
  ...
  getTilePixelSize(e, n, i) {
    const r = this.getTileGridForProjection(i),
      ...
      o = pt(r.getTileSize(e), this.tmpSize);
    return s == 1 ? o : Jv(o, s, this.tmpSize);
  }
  getTileCoordForTileUrlFunction(e, n) {
    n = n !== void 0 ? n : this.getProjection();
    const i = this.getTileGridForProjection(n);
    return (
      this.getWrapX() && n.isGlobal() && (e = EC(i, e, n)), uC(e, i) ? e : null
    );
  }
  clear() {
...
function IC(t, e) {
  const n = t.length,
    i = new Array(n);
  for (let r = 0; r < n; ++r) i[r] = TC(t[r], e);
  return LC(i);
}
function LC(t) {
  return t.length === 1
  ...
  constructor(e) {
    super({
      ...
      (this.generateTileUrlFunction_ =
        this.tileUrlFunction === Md.prototype.tileUrlFunction),
        ...
        (s =
          r == G.ERROR
            ...
            : r == G.LOADED
              ? Wu.TILELOADEND
              : void 0)),
      s != null && this.dispatchEvent(new RC(s, n));
  }
...
`);
    this.generateTileUrlFunction_
      ? this.setTileUrlFunction(IC(e, this.tileGrid), n)
      : this.setKey(n);
  }
...
class PC extends Md {
  constructor(e) {
    super({
      ...
      state: e.state,
      tileGrid: e.tileGrid,
      tileLoadFunction: e.tileLoadFunction ? e.tileLoadFunction : MC,
      tilePixelRatio: e.tilePixelRatio,
...
class S0 extends AC {
  constructor(e) {
    e = e || {};
    let n;
    e.attributions !== void 0 ? (n = e.attributions) : (n = [OC]);
...
function NC(t, e, n) {
  return Array.isArray(e[0])
    ? (D_(t, 0, e, n) || ((t = t.slice()), Uc(t, 0, e, n)), t)
    : (gd(t, 0, e, n) || ((t = t.slice()), ql(t, 0, e, n)), t);
}
function R0(t, e) {
  var s;
  const n = t.geometry;
  if (!n) return [];
  if (Array.isArray(n)) return n.map((o) => R0({ ...t, geometry: o })).flat();
  ...
  return Ad(
    new et(
      i,
      i === "Polygon" ? NC(n.flatCoordinates, n.ends, r) : n.flatCoordinates,
...
function Od(t, e) {
  if (!t) return null;
  if (Array.isArray(t)) {
    const i = t.map((r) => Od(r, e));
    return new ax(i);
  }
  const n = DC[t.type];
  return Ad(new n(t.flatCoordinates, t.layout, t.ends), !1, e);
}
class zC extends FC {
  constructor() {
    super();
...
class GC extends zC {
  ...
  readFeatureFromObject(e, n) {
    ...
    const r = Fd(i.geometry);
    if (this.featureClass === et)
      return R0({ geometry: r, id: i.id, properties: i.properties }, n);
    const s = new Ia();
    return (
      this.geometryName_
  ...
  writeFeatureObject(e, n) {
    ...
    const s = e.getProperties(),
      o = e.getGeometry();
    return (
      o && ((i.geometry = Jc(o, n)), delete s[e.getGeometryName()]),
      Xi(s) || (i.properties = s),
      i
    );
  }
  ...
  writeGeometryObject(e, n) {
    return Jc(e, this.adaptOptions(n));
  }
}
function Fd(t, e) {
  if (!t) return null;
...
const eS = GC;
function tS({ setLayers: t }) {
  const [e, n] = pn.useState(!1),
    i = pn.useMemo(
      () =>
        new lx({ source: new px({ url: "/kommuner.json", format: new eS() }) }),
      [],
    );
  return (
    pn.useEffect(() => {
    ...
    Je.createElement(
      ...
      Je.createElement(
        ...
        Je.createElement(Je.Fragment, null, e ? "Hide" : "Show", " Kommuner"),
      ),
    )
  );
}
Fv();
const Zg = new sC({
  layers: [new E0({ source: new S0() })],
  view: new Kt({ center: [10, 60], zoom: 8 }),
});
function nS() {
  const [t, e] = pn.useState([new E0({ source: new S0() })]),
    n = pn.useRef();
  return (
    pn.useEffect(() => {
      Zg.setLayers(t);
    ...
    pn.useEffect(() => {
      Zg.setTarget(n.current);
    }, []),
    Je.createElement(
      Je.Fragment,
      null,
      Je.createElement("header", null, Je.createElement("h1", null, "Map")),
      Je.createElement("nav", null, Je.createElement(tS, { setLayers: e })),
      Je.createElement("main", { ref: n }, "Here is the map"),
    )
  );
}
const iS = ju.createRoot(document.getElementById("root"));
iS.render(Je.createElement(nS, null));
